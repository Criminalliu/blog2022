...
import cn.yinong.utils.Commons;
...
//            AttAchDomain attAch = localService.localUpLoad(file, request);
...
//            response.getWriter().w+rite( "{\"success\": 1, \"message\":\"上传成功\",\"url\":\"" + pathname + "\"}" );
